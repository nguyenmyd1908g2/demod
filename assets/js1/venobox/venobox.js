    ...
    $.fn.extend({
        ...
        venobox: function(options) {
            ...
            return this.each(function() {
                ...
                obj.on('click', function(e){
                    ...
                    overlay.animate({opacity:1}, 250, function(){
                        ...
                        if (obj.data('vbtype') == 'iframe') {
                          ...
                          content.html('<img src="../../vendor/venobox/'+dest+'">');
                          preloadFirst();
                        }
                ...
                function checknav(){
                    ...
                    if ( obj.data('vbtype') !== 'iframe' && obj.data('vbtype') !== 'inline' && obj.data('vbtype') !== 'ajax' ) {
                        sharelinks = { 
                            ...
                            download  : '<a target="_blank" href="../../vendor/venobox/'+obj.prop('href')+'">'+downloadIcon+'</a>'
                        };
                ...
                /* -------- LOAD IFRAME -------- */
                function loadIframe(){
                    content.html('<iframe class="venoframe" src="../../vendor/venobox/'+dest+'"></iframe>');
                ...
                function loadVid(autoplay){
                    ...
                    content.html('<iframe class="venoframe vbvid" webkitallowfullscreen mozallowfullscreen allowfullscreen allow="autoplay" frameborder="0" src="../../vendor/venobox/'+player+videoObj.id+queryvars+'"></iframe>');
                    updateoverlay();
                }
